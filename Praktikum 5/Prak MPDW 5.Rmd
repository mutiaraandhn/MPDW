...
Berdasarkan uji ADF tersebut, didapat *p-value* sebesar 0.01295 yang lebih kecil dari taraf nyata 5% sehingga tolak $H_0$ dan menandakan bahwa data stasioner dalam rataan. Hal ini sesuai dengan hasil eksplorasi menggunakan plot time series dan plot ACF.
...
Gambar di atas menunjukkan nilai *rounded value* ($\lambda$) optimum sebesar **1.818182** dan pada selang kepercayaan 95% nilai memiliki batas bawah **0** dan batas atas **4.78787879**. Selang tersebut memuat nilai satu sehingga dapat dikatakan bahwa data bangkitan stasioner dalam ragam.